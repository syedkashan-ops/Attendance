    ...
    js="""
        export default function({ parentElement, setStateValue }) {
            ...
            button.onclick = () => {
                ...
                status.textContent = 'Requesting current GPS location...';
                ...
                navigator.geolocation.getCurrentPosition(
                    (position) => {
                        ...
                        status.textContent = 'GPS location captured.';
                    ...
                    (error) => {
                        ...
                        if (error.code === 3) message = 'Location request timed out. Please try again in an open area.';
                        status.textContent = message;
